...
- [extension.ts][def]: Command registration, extension lifecycle
- [DotnetCoreAcquisitionWorker.ts](../vscode-dotnet-runtime-library/src/Acquisition/DotnetCoreAcquisitionWorker.ts): Core acquisition logic
- All event types are defined in the EventStream directory (see `vscode-dotnet-runtime-library/src/EventStream/`)
- [IAcquisitionWorkerContext.ts][<def]ts): Dependency injection interface>
<!-- Detailed acquisition strategy documentation file not present -->
...
[def]: ../vscode-dotnet-runtime-extension/src/extension.ts

[def]: ../vscode-dotnet-runtime-library/src/Acquisition/IAcquisitionWorkerContext